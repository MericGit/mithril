...
url = 'http://export.arxiv.org/api/query?search_query=all:exoskeleton&start=0&max_results=8'
...
for idx, entry in enumerate(entries):
    ...
    file_name = os.path.join(current_directory, f"exoskeleton{idx+1}.xml")
